...
const Repos = () => {
  ...
  const fetchAllRepos = async () => {
    ...
    // await axios.get(`https://api.github.com/users/bayotics/repos?per_page=6&page=${currentPage}`).then(
    //         (data) => {
    //             const viewMoreFunc = () => {
    //                 setRepos ([...repos, ...data]);
    ...
    //         }
    //     )
    fetch(`https://api.github.com/users/bayotics/repos?per_page=6&page=${currentPage}`)
